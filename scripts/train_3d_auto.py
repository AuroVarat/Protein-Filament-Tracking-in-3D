...
from unet3d import TinyUNet3D, SegDataset3DAuto, dice_loss
from utils import best_device

MASK_DIR = "models/masks3d"
SAVE_PATH = "models/filament_unet3d_auto.pt"
...
def main():
    ...
    print(f"\n3D Model params (1-ch, Auto-Threshold): {sum(p.numel() for p in model.parameters()):,} ({device})")

    ds = SegDataset3DAuto(volumes, masks, augment_factor=10, intensity_thresh=0.5)
