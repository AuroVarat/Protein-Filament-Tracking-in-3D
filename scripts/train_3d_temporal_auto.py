#!/usr/bin/env python3
"""
Filament 3D Temporal Trainer (Dilated Auto-Thresholding)

Trains a 3D U-Net taking 3 temporal frames (t-1, t, t+1) and predicting masks for all 3.
Uses dilated auto-thresholding to expand underestimated manual blobs before intersecting with raw intensity.
Initializes with weights from the 1-channel model.

Usage:
    python scripts/train_3d_temporal_auto.py
"""
...
SAVE_PATH = "models/filament_unet3d_temporal_auto.pt"
...
def main():
    ...
    log_file = "models/train_temporal_auto_log.csv"
